//
//  CaloriesConsumedDinnerListView.swift
//  INFITS-App
//
...
struct CaloriesConsumedDinnerListView: View {
    @State var searchbar = ""
...
struct CaloriesConsumedDinnerListView_Previews: PreviewProvider {
    static var previews: some View {
        CaloriesConsumedDinnerListView()
    }
}
